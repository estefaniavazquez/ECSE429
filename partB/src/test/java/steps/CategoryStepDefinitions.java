...
public class CategoryStepDefinitions {
    ...
    // Local alias store (e.g., "category_id" -> "123"); kept internal to this
    // class.
    ...
    public void the_list_should_contain_at_least_categories(Integer expectedMin) {
        ...
        // If this is an error response (e.g., 406), there is no list – treat as 0
        // safely.
    ...
    public void when_i_verify_deletion_by_requesting_get_categories_delete_category_id_the_response_should_be(
            Integer expected) {
    ...
    public void when_i_verify_deletion_by_requesting_get_categories_the_response_should_be_int(Integer numericId,
            Integer expected) {
    ...
    private String resolveTargetId(String raw) {
        ...
        if (raw.endsWith("_category_id") || raw.equals("category_id") || raw.equals("view_category_id")
                || raw.equals("delete_category_id")) {
    ...
    private boolean statusAcceptable(int expected, Response r) {
        ...
        // Accept 200 instead of 204 on delete for backends that return OK with empty
        // body
        if (expected == 204 && actual == 200)
            return true;
    ...
    private String flexibleField(Response r, String field) {
        ...
        if (v != null && field.equals("title"))
            return v;
        v = safeJsonGetString(r, "description");
        if (v != null && field.equals("description"))
            return v;
    ...
    private String normalizeEmpty(String s) {
        if (s == null)
            return "";
        if ("[empty]".equalsIgnoreCase(s.trim()))
            return "";
        return s;
    }
    ...
    private void assertErrorMessageMatches(String expected) {
        ...
        boolean matches = body.contains(e) ||
