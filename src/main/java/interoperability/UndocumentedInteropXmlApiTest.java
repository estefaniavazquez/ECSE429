...
public class UndocumentedInteropXmlApiTest extends BaseApiTest {
    ...
    /**
     * Tests the GET /todos/{id}/categories/{id} endpoint with XML format.
     * This test verifies that GET method on specific relationship ID endpoints
     * is not supported when using XML. The API doesn't support getting individual
     * relationship
     ...
     */
    @Test
    public void testGetTodoCategoryIdXml() throws Exception {
        System.out.println("Running testGetTodoCategoryIdXml...");

        XmlMapper xmlMapper = new XmlMapper();

        // First create a todo
        String todoXml = "<todo><title>Test Todo for GET ID</title><doneStatus>false</doneStatus><description>Test description</description></todo>";
        ...
        connection.disconnect();
        System.out.println("testGetTodoCategoryIdXml passed.");
    }

    /**
     * Tests the POST /todos/{id}/categories/{id} endpoint with XML format.
     * This test verifies that POST method on specific relationship ID endpoints
     * is not supported when using XML. POST should only work on collection
     * endpoints.
     * Expected: 405 Method Not Allowed for POST on specific relationship ID.
     */
    @Test
    public void testPostTodoCategoryIdXml() throws Exception {
        System.out.println("Running testPostTodoCategoryIdXml...");

        XmlMapper xmlMapper = new XmlMapper();

        // First create a todo
        String todoXml = "<todo><title>Test Todo for POST ID</title><doneStatus>false</doneStatus><description>Test description</description></todo>";
        ...
        connection.disconnect();
        System.out.println("testPostTodoCategoryIdXml passed.");
    }
    ...
    /* Test HEAD method on specific relationship ID endpoints */

    /**
     * Tests the HEAD /todos/{id}/categories/{id} endpoint with XML format.
     * This test verifies that HEAD method on specific relationship ID endpoints
     * is not supported when using XML format.
     * Expected: 405 Method Not Allowed.
     */
    @Test
    public void testHeadTodoCategoryIdXml() throws Exception {
        System.out.println("Running testHeadTodoCategoryIdXml...");

        XmlMapper xmlMapper = new XmlMapper();

        // First create a todo
        String todoXml = "<todo><title>Test Todo for HEAD ID</title><doneStatus>false</doneStatus><description>Test description</description></todo>";
        ...
        // Try HEAD on specific relationship ID endpoint (should be method not allowed)
        String endpoint = String.format(TODOS_CATEGORIES_ID_ENDPOINT, createdTodo.getId(), "1");
        ...
        connection.disconnect();
        System.out.println("testHeadTodoCategoryIdXml passed.");
    }

    /**
     * Tests the HEAD /projects/{id}/tasks/{id} endpoint with XML format.
     * This test verifies that HEAD method on specific relationship ID endpoints
     * is not supported when using XML format.
     * Expected: 405 Method Not Allowed.
     */
    @Test
    public void testHeadProjectTaskIdXml() throws Exception {
        System.out.println("Running testHeadProjectTaskIdXml...");

        XmlMapper xmlMapper = new XmlMapper();

        // First create a project
        String projectXml = "<project><title>Test Project for HEAD ID</title><completed>false</completed><active>true</active><description>Test description</description></project>";
        ...
        // Try HEAD on specific relationship ID endpoint (should be method not allowed)
        String endpoint = String.format(PROJECTS_TASKS_ID_ENDPOINT, projectId, "1");
        HttpURLConnection connection = request(endpoint, HEAD_METHOD, XML_FORMAT, XML_FORMAT, null);
        ...
        connection.disconnect();
        System.out.println("testHeadProjectTaskIdXml passed.");
    }
}